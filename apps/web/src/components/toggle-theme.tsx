...
const toggleThemeVariants = cva("group bg-background dark:bg-forground", {
  variants: {
    variant: {
      ...
      simple:
        "border-none bg-none hover:text-white hover:bg-gray-300 dark:data-[state=on]:bg-slate-900 hover:data-[state=on]:bg-gray-300 dark:hover:data-[state=on]:bg-slate-300 dark:group-hover:text-slate-900 data-[state=on]:bg-background",
    },
    rounded: {
      sm: "rounded-sm",
      md: "rounded-md",
